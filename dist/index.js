(function (deckyFrontendLib, React, require$$8) {
  'use strict';
  ...
  const MultiSelectedOption = ({ option, fieldProps, onRemove }) => {
      return (window.SP_REACT.createElement(deckyFrontendLib.Field, { label: option.label, ...fieldProps },
          window.SP_REACT.createElement(deckyFrontendLib.Focusable, { style: { display: 'flex', width: '100%', position: 'relative' } },
              window.SP_REACT.createElement(deckyFrontendLib.DialogButton, { style: { height: "40px", minWidth: "40px", width: "40px", display: "flex", justifyContent: "center", alignItems: "center", padding: "10px" }, onClick: () => onRemove(option), onOKButton: () => onRemove(option), onOKActionDescription: `Remove ${option.label}` },
  ...
  const MultiSelect = ({ options, selected, label, onChange = () => { }, maxOptions, fieldProps }) => {
      ...
      return (window.SP_REACT.createElement(deckyFrontendLib.Focusable, null,
          ...
          window.SP_REACT.createElement(deckyFrontendLib.Dropdown, { rgOptions: available, selectedOption: dropLabel, onChange: onSelectedChange, strDefaultLabel: dropLabel, focusable: true, disabled: available.length == 0 || (!!maxOptions && selected.length == maxOptions) })));
  };
  ...
  const AddScreenshot = () => {
      ...
      return (window.SP_REACT.createElement(React.Fragment, null,
          ...
          .deckshare-scoper .${deckyFrontendLib.quickAccessControlsClasses.PanelSection} {
            width: inherit;
            height: inherit;
            padding: 0px;
          }
        `),
          window.SP_REACT.createElement("div", { className: "deckshare-scoper" },
              window.SP_REACT.createElement(deckyFrontendLib.PanelSection, null,
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.Field, { label: "Screenshot Name", description: window.SP_REACT.createElement(deckyFrontendLib.TextField, { label: 'Name', value: name, onChange: (e) => { setName(e?.target.value); } }) })),
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.Field, { label: "Screenshot Command", description: window.SP_REACT.createElement(deckyFrontendLib.TextField, { label: 'Command', value: cmd, onChange: (e) => { setCmd(e?.target.value); } }) })),
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "Does this launch an app?", onChange: (e) => {
                              setIsApp(e);
                              if (e)
                                  setPassFlags(false);
                          }, checked: isApp })),
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "Does this screenshot use flags?", onChange: (e) => { setPassFlags(e); }, checked: passFlags, disabled: isApp })),
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.Field, { label: "Hooks", highlightOnFocus: false, description: window.SP_REACT.createElement(MultiSelect, { label: "Select a hook", options: hookAsOptions, selected: [], onChange: (selected) => { setHooks(selected.map((s) => s.label)); } }) })),
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { layout: "below", onClick: saveScreenshot, disabled: !ableToSave, bottomSeparator: 'none' }, "Save"))))));
  };
      ...
      return (window.SP_REACT.createElement(React.Fragment, null,
          window.SP_REACT.createElement(deckyFrontendLib.ConfirmModal, { bAllowFullSize: true, onCancel: closeModal, onEscKeypress: closeModal, onOK: () => {
              ...
              window.SP_REACT.createElement(deckyFrontendLib.PanelSection, { title: title },
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.Field, { label: "Name", description: window.SP_REACT.createElement(deckyFrontendLib.TextField, { value: name, onChange: (e) => { setName(e?.target.value); } }) })),
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.Field, { label: "Command", description: window.SP_REACT.createElement(deckyFrontendLib.TextField, { value: cmd, onChange: (e) => { setCmd(e?.target.value); } }) })),
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "Does this launch an app?", onChange: (e) => {
                              setIsApp(e);
                              if (e)
                  ...
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.ToggleField, { label: "Does this screenshot use flags?", onChange: (e) => { setPassFlags(e); }, checked: passFlags, disabled: isApp })),
                  window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                      window.SP_REACT.createElement(deckyFrontendLib.Field, { label: "Hooks", highlightOnFocus: false, description: window.SP_REACT.createElement(MultiSelect, { label: "Select a hook", options: hookAsOptions, selected: hookAsOptions.filter((hookOpt) => hooks.includes(hookOpt.label)), onChange: (selected) => { setHooks(selected.map((s) => s.label)); } }) }))))));
  };

  const showContextMenu = deckyFrontendLib.findModuleChild((m) => {
      if (typeof m !== 'object')
          return undefined;
      for (let prop in m) {
  ...
  const Menu = deckyFrontendLib.findModuleChild((m) => {
      if (typeof m !== 'object')
          return undefined;
      for (let prop in m) {
  ...
  const MenuItem = deckyFrontendLib.findModuleChild((m) => {
      if (typeof m !== 'object')
          return undefined;
      for (let prop in m) {
  ...
  const ManageScreenshots = () => {
      ...
      return (window.SP_REACT.createElement(React.Fragment, null,
          ...
          screenshotsList.length > 0 ? (window.SP_REACT.createElement(React.Fragment, null,
              window.SP_REACT.createElement(deckyFrontendLib.ReorderableList, { entries: reorderableScreenshots, onSave: onSave, interactables: Interactables }),
              window.SP_REACT.createElement(deckyFrontendLib.ButtonItem, { layout: "below", onClick: reload }, "Reload Screenshots"))) : (window.SP_REACT.createElement("div", { style: { width: "100%", display: "flex", justifyContent: "center", alignItems: "center", padding: "5px" } }, "Loading..."))));
  };
  ...
  const SettingsField = ({ field }) => {
      ...
      return (window.SP_REACT.createElement(deckyFrontendLib.TextField, { label: field.shortTitle, value: fieldVal, onChange: onChange, description: field.description, mustBeNumeric: field.mustBeNumeric }));
  };
  const Settings = ({}) => {
      const fields = [
          {
      ...
      return (window.SP_REACT.createElement(React.Fragment, null,
        ...
        `),
          window.SP_REACT.createElement("div", { className: "deckshare-scoper" },
              window.SP_REACT.createElement(deckyFrontendLib.PanelSection, null, fields.map((field) => (window.SP_REACT.createElement(deckyFrontendLib.PanelSectionRow, null,
                  window.SP_REACT.createElement(deckyFrontendLib.Field, { label: field.title, description: window.SP_REACT.createElement(SettingsField, { field: field }) }))))))));
  };
  ...
  const GuidePage = ({ content }) => {
      ...
      `),
          window.SP_REACT.createElement("div", { className: "deckshare__guide-container" },
  ...
  const ScreenshotsManagerRouter = ({ guides }) => {
      ...
      return (window.SP_REACT.createElement(deckyFrontendLib.SidebarNavigation, { title: "Plugin Config", showTitle: true, pages: [
              {
  ...
  var index = deckyFrontendLib.definePlugin((serverApi) => {
      ...
      PyInterop.getGuides().then((res) => {
          ...
          serverApi.routerHook.addRoute("/deckshare-config", () => (window.SP_REACT.createElement(ScreenshotsContextProvider, { screenshotsStateClass: state },
