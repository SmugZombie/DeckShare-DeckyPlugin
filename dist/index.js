(function (deckyFrontendLib, React, require$$8) {
  ...
  const ShortcutsManagerRouter = ({ guides }) => {
      const guidePages = {};
  ...
  var index = deckyFrontendLib.definePlugin((serverApi) => {
      ...
      PyInterop.getGuides().then((res) => {
          ...
          serverApi.routerHook.addRoute("/bash-shortcuts-config", () => (window.SP_REACT.createElement(ShortcutsContextProvider, { shortcutsStateClass: state },
              window.SP_REACT.createElement(ShortcutsManagerRouter, { guides: guides }))));
      });
      return {
