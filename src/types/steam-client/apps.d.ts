...
type Apps = {
  ...
  AddScreenshot: (appName: string, exePath: string, startDir: string, launchArgs: string) => number,
  RemoveScreenshot: (appId: number) => void,
  GetScreenshotData: any,

  SetScreenshotLaunchOptions: any, //(appId: number, options: string) => void,
  SetScreenshotName: (appId: number, newName: string) => void,
  SetScreenshotStartDir: (appId: number, startDir: string) => void,
  SetScreenshotExe: (appId: number, exePath: string) => void,
...
type SteamAppDetails = {
  ...
  strScreenshotExe:string,
  strScreenshotLaunchOptions:string,
  strScreenshotStartDir:string,
...
type SteamAppOverview = {
  ...
  screenshot_override_appid: undefined,
